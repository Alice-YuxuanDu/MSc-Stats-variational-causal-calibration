"""Reproduce Figure 1 directly from the saved simulation results."""
...
DATA_FILE = ROOT / "results/figure_data/figure1_rff_mf/posterior_metrics.csv"
OUTPUT_DIR = ROOT / "results/figures"

PANELS = [
    ("RFF GP", "rff_full_gaussian", "rff_full_gaussian_onestep_logistic_pi"),
    ("Mean-field VI", "rff_meanfield_vi", "rff_meanfield_vi_onestep_logistic_pi"),
]
...
def main():
    ...
    stem = OUTPUT_DIR / "synthetic_rff_mf_posterior_mean_1x2_strong_homogeneous_m200"
