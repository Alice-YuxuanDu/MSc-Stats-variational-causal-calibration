"""Run Module 2 exact GP raw posterior baseline."""
...
def run(args: argparse.Namespace) -> None:
    ...
    for scenario_idx, (overlap, effect) in enumerate(scenarios):
        ...
        for rep in range(args.reps):
            ...
            effect_draws = sample_counterfactual_effects(
                posterior,
                n_units=args.n,
                n_draws=args.draws,
                rng=rng,
            ...
            for estimand, (draws, true_value) in estimands.items():
                metric_rows.append(
                    {
                        "scenario": scenario,
                        "rep": rep,
    ...
    dataset_path = output_dir / "exact_gp_dataset_summaries.csv"
    metric_path = output_dir / "exact_gp_posterior_metrics.csv"
    aggregate_path = output_dir / "exact_gp_posterior_metrics_aggregated.csv"
